                    ...
                    <div className='d-lg-flex '>
                        <div className="col-lg-7 col-12 text=center ">
                            <div className='d-lg-inline-block d-flex flex-column  align-items-center '>
                                <p data-aos="fade-left" data-aos-duration="1000">My name is Kaleeswaran, I am a Fullstack developer with a great passion for programming. I am passionate about delivering solutions that add value to people's lives and at the same time challenge me. Improved my skills as a Fullstack </p>
